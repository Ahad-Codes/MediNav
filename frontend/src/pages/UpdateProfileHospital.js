        ...
        const fetchData = async () => {
            try {
                const response = await axios.post(
                    "https://medinav-backend-8gvrb.ondigitalocean.app/user/getHospitalDetails",
                    {
                        userID,
                    }
                );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                "https://medinav-backend-8gvrb.ondigitalocean.app/user/updateHospital",
                updatedHospitalData
            );
            console.log(response.data);
                        ...
                        <form className="row g-3" onSubmit={handleSubmit}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    id="inputPassword4"
                                    placeholder={
                                        hospitalData.secondaryMobileNumber
                                    }
                                    onChange={(e) =>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setNumOnCallDoctors(e.target.value)
                                    }
                                />
                            </div>
                            <div class="col-md-6">
